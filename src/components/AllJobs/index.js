...
class AllJobs extends Component {
  state = {
    ...
    apiJobsStatus: apiJobsStatusConsonants.initial,
  }
  ...
  onGetProfileDetails = async () => {
    ...
    if (responseProfile.ok === true) {
      ...
      this.setState({
        apiStatus: apiStatusConsonants.failure,
      })
    }
  }

  onGetJobDetails = async () => {
    this.setState({apiJobsStatus: apiJobsStatusConsonants.inProgress})
    const jwtToken = Cookies.get('jwt_token')
    ...
    if (responseJobs.ok === true) {
      ...
      this.setState({
        ...
        apiJobsStatus: apiJobsStatusConsonants.success,
      })
    } else {
      this.setState({
        apiJobsStatus: apiJobsStatusConsonants.failure,
      })
    }
  }
  ...
  onGetJobsFailureView = () => (
    <div className="failure-img-button-container">
      ...
      <h1 className="failure-heding">Oops! Something Went Wrong</h1>
  ...
  onRenderJobsStatus = () => {
    ...
    switch (apiJobsStatus) {
      case apiJobsStatusConsonants.success:
        return this.onGetJobsView()
      case apiJobsStatusConsonants.failure:
        return this.onGetJobsFailureView()
      case apiJobsStatusConsonants.inProgress:
        return this.renderLoadingView()
      default:
        return null
    }
